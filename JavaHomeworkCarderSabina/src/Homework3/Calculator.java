...
public class Calculator extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jtxt, javax.swing.GroupLayout.PREFERRED_SIZE, 262, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(jButton12, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 61, Short.MAX_VALUE)))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jtxt, javax.swing.GroupLayout.PREFERRED_SIZE, 84, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(33, 33, 33)
    ...
    private void jtxtActionPerformed(java.awt.event.ActionEvent evt) {                                     
        // TODO add your handling code here:
    }                                    

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {                                         
     String EnterNum = jtxt.getText() + jButton2.getText();
         jtxt.setText(EnterNum);
    }                                        

    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {                                         
       String EnterNum = jtxt.getText() + jButton7.getText();
         jtxt.setText(EnterNum);
    }                                        
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        String EnterNum = jtxt.getText() + jButton9.getText();
         jtxt.setText(EnterNum);
    }                                        
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        String EnterNum = jtxt.getText() + jButton6.getText();
         jtxt.setText(EnterNum);
    }                                        
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        String EnterNum = jtxt.getText() + jButton1.getText();
         jtxt.setText(EnterNum);
    }                                        

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {                                         
       String EnterNum = jtxt.getText() + jButton3.getText();
         jtxt.setText(EnterNum);
    }                                        

    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        String EnterNum = jtxt.getText() + jButton5.getText();
         jtxt.setText(EnterNum);
    }                                        

    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {                                          
        String EnterNum = jtxt.getText() + jButton10.getText();
         jtxt.setText(EnterNum);
    }                                         

    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {                                          
        String EnterNum = jtxt.getText() + jButton11.getText();
         jtxt.setText(EnterNum);
    }                                         
    ...
    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {                                          
        String EnterNum = jtxt.getText() + jButton13.getText();
         jtxt.setText(EnterNum);
    }                                         

    private void jButton14ActionPerformed(java.awt.event.ActionEvent evt) {                                          
        String EnterNum = jtxt.getText() + jButton14.getText();
         jtxt.setText(EnterNum);
    }                                         
